    ...
    .then((data) => {
      ...
      data.projects.forEach((project, index) => {
        ...
        projectsList.innerHTML += `
          ...
          <div>
          ${project.images ? `<img src="${project.images[0]}" alt="${project.name}">` : `<div class="project-img-placeholder"><img src="assets/media/no_image.png" alt="${project.name}"><span>No Image</span></div>`}
          <h4>${project.name}</h4>
